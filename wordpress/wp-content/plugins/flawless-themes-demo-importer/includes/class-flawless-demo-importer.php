...
if (!function_exists('flawlessthemes_importer_import_files')) {
	...
	add_filter( 'pt-ocdi/plugin_intro_text', 'ocdi_plugin_intro_text' );
        return array(
            ...
            array(
                'import_file_name' => esc_html__('Music Artist', 'flawless-demo-importer'),
                ...
                'import_notice' => esc_html__('Make Sure you are using the Music Artist Theme (Free Version)', 'flawless-demo-importer'),
