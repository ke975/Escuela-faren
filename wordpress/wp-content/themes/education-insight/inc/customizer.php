...
function education_insight_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_control('education_insight_post_sidebar',array(
       'type' => 'checkbox',
       'label' => __('Check to show fullwidth','education-insight'),
    ...
    $wp_customize->add_control('education_insight_single_post_sidebar',array(
       'type' => 'checkbox',
       'label' => __('Check to show single post fullwidth','education-insight'),
       'section' => 'education_insight_layout',
    ));
	...
	$wp_customize->add_setting('education_insight_email',array(
		'default' => '',
		'sanitize_callback' => 'education_insight_sanitize_email'
	)); 
	...
	$wp_customize->add_setting('education_insight_slider_arrows',array(
       'default' => true,
       'sanitize_callback'	=> 'education_insight_sanitize_checkbox'
    ));
    $wp_customize->add_control('education_insight_slider_arrows',array(
       'type' => 'checkbox',
...
if (class_exists('WP_Customize_Control') && !class_exists('Education_Insight_Pro_Control')):
    ...
    public function render_content(){?>
        <label style="overflow: hidden; zoom: 1;">
			...
			<p><?php printf(__('Please review us if you love our product on %1$sWordPress.org%2$s. </br></br>  Thank You', 'education-insight'), '<a target="blank" href="https://wordpress.org/support/theme/education-insight/reviews/?filter=5">', '</a>');
            ?></p>
        </label>
    <?php } }
endif;